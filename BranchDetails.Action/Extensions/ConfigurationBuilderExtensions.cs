...
{
    public static IConfigurationBuilder AddGitHubActionSecrets(this IConfigurationBuilder config)
    {
        ...
        var userSecrets = config.AddUserSecrets<Program>().Build();
        
        foreach (var secret in userSecrets.AsEnumerable())
        {
